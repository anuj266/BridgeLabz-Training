// Program to store the marks of the students in physics, chemistry, and maths in a 2D array and then compute the percentage and grade
package array;
import java.util.Scanner;
public class MarksOfStudent2D {
