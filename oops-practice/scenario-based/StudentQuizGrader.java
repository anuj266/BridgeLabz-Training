...
//			
//	};
//	static int score(String[] correctAnswers , String[] studentAnswer) {
//		int count = 0;
//		for(int i=0;i<10;i++) {
//			if(correctAnswers[i].equalsIgnoreCase(studentAnswer[i])) {
...
//		System.out.println("Enter you Answer for quiz (Answer A,B,C,D)");
//		for(int i=0;i<10;i++) {
//			studentAnswer[i] = sc.nextLine();
//		}
//		StudentQuizGrader ans = new StudentQuizGrader();
//		int count = ans.score(correctAnswers, studentAnswer);
//		System.out.println("The total number of correct answers are = "+count);
//		
//	}
//
//}
